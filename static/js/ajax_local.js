...
// phone mincart show// phone mincart show // phone mincart show // phone mincart show // phone mincart show // phone mincart show
        $(".header_div_m_shop").find("b").bind("click",function(){
            console.log($(".message").css("display"));
             $(".message").css("display",$(".message").css("display")=="none"?"block":"none");
          ...
          if(objcustomercustomerprofiles.length>=1){
            ...
            $(".header_div_m_left").find("b").click(function(){
                if($(".header_div_m_left_show").css("position")=="absolute"){
                     // alert(1);
                     $("body").toggleClass("bodymove");
                     $(".header_div_m_left_show").css("position","fixed");
                     $(".header_div_m_left_show").css("top","0px");
                     ...
                     //  $(".message_row_left").css("display","block");
                     // }

                     //In view of the uc browser etc and is work
                      var left = 0;
                   ...
                   //In view of the general browser
                   document.addEventListener('touchmove', function (event) {
                    ...
                    $("body").toggleClass("bodymove");
                    $(".header_div_m_left_show").css("position","absolute");
                    $(".header_div_m_left_show").css("top","-52px");
